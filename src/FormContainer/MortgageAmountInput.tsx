  ...
  return (
    <div className="w-[100%]">
      ...
      <div className="flex  border border-[#6B94A8] rounded-[5px]">
        <div className={`w-[44px] lg:h-[48px] h-[24px] flex justify-center items-center ${error ? 'bg-[#D73328]':'bg-[rgb(228,244,253)]' } rounded-tl-[5px] rounded-bl-[5px]`}>
          £
        </div>
        <input
          type="number"
          className="w-[90%]  rounded-tr-[5px] rounded-br-[5px]"
          onChange={(e) => {
