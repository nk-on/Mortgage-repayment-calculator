...
export default function Results() {
  ...
  return (
    <>
      ...
      <div
        className=" flex flex-col gap-[30px] p-[30px] w-[90%] lg:h-[250px] min-h-[40%] shadow-[0px_-10px_0px_0px_rgba(216,219,47,1)] rounded-[7px] mt-[70px]"
        style={{ background: "rgba(0, 0, 0, 0.25)" }}
      >
        <div className="flex flex-col gap-[20px]">
          <p className="text-[#9ABED5]">Your Monthly repayment</p>
          <h1 className="text-[#D8DB2F] text-[25px] font-bold">
